...
const processAddtoCart = (btnCart,quantity=1)=>{
...
if(btnCart){
    ...
    processAddtoCart(btnCart,quantity.value);
    quantity.value=1;
}
const iconCarts = document.querySelectorAll(".icon_bag_alt");
if(iconCarts){
    iconCarts.forEach(iconCart=>{
        processAddtoCart(iconCart)
    })
}
