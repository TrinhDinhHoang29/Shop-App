...
const productsController = __importStar(require("../../controllers/admin/products.controller"));
const multer_1 = __importDefault(require("multer"));
const upload = (0, multer_1.default)();
const uploadCloud = __importStar(require("../../middlewares/uploadCloud.middleware"));
const validate = __importStar(require("../../validates/products.validate"));
...
router.patch("/edit/:id", upload.fields([
    { name: "thumbnail", maxCount: 1 },
    { name: "images", maxCount: 3 }
]), uploadCloud.uploadFields, validate.valiEdit, productsController.editPatch);
